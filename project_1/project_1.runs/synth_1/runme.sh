...
HD_PWD='C:/Users/Dell/Desktop/Vivado/Somador_display7seg/Somador_display7seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cont_display.vds -m64 -mode batch -messageDb vivado.pb -notrace -source cont_display.tcl
